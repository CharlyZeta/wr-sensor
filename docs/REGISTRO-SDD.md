...
| FIX-0008 | Seguridad del punto de entrada: secreto WS, headers/CSP y hosting seguro | 2026-09-15 | 2026-09-15 | ✅ 24/24 | Unit (16) · IT (8) · gateway 84+37 |`n| FEAT-0009 | SPA núcleo: sesión, shell, mapa y hosting desde el gateway | *(Gate)* | — | 🔴 0/32 (Gate STRICT) | Pendiente de HO-Gate: parte 1 de 4 del frontend |
...
| `api-gateway` | 84 | 37 | `TablaRutasTest` 9 · `RateLimiterTest` 7 · `FiltroRateLimitTest` 6 · `ConfiguracionGatewayTest` 5 · `CorrelacionTest` 4 · `VerificadorJwtTest` 7 · `AutenticadorWsTest` 8 · `FiltroCorsTest` 11 · `FEAT0008DocsTest` 11 · ITs (`FEAT0007MainFlowIT` 16 + `FEAT0008MainFlowIT` 13) |

**Total: 323 unit/assert + 115 ITs = 438 verdes** (JUnit 5, AssertJ, StepVerifier,
