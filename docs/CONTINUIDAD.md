...
- **Estado**: **19 work items RESOLVED** (12 FEAT + 7 FIX), **464/464 criterios ✅**, **470 tests**
  (328 unit + 120 IT + 22 del SPA). **Abierta la serie del frontend**: 4 contracts en **Gate** (DRAFT, esperando
...
implementados y con tests verdes** (`api-gateway` 89+42 · `query-api` 33+8 · `web/` 22).
