...
- **Estado**: **19 work items RESOLVED** (12 FEAT + 7 FIX), **493/493 criterios ✅**, **490 tests**
  (333 unit + 120 IT + 37 del SPA). **Abierta la serie del frontend**: 4 contracts en **Gate** (DRAFT, esperando
...
implementados y con tests verdes** (`api-gateway` 94+42 · `query-api` 33+8 · `web/` 37).
